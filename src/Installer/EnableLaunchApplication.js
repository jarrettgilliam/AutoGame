// https://stackoverflow.com/a/53554367/987968
// https://stackoverflow.com/a/7171738/987968
...
var filename = "AutoGame.exe";   // The name of the executable to launch - change this to match the file you want to launch at the end of your setup
...
try {
    ...
    sql = "INSERT INTO `CustomAction` (`Action`, `Type`, `Source`, `Target`) VALUES ('VSDCA_Launch', '226', 'TARGETDIR', '[TARGETDIR]\\" + filename + "')";
    view = database.OpenView(sql);
    view.Execute();
    view.Close();
