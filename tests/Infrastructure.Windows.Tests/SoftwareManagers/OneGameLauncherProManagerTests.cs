...
public class OneGameLauncherProManagerTests
{
    private const string SOFTWARE_NAME = "OneGameLauncherPro";
    ...
    public OneGameLauncherProManagerTests()
    {
        ...
        this.user32ServiceMock
            .Setup(x => x.FindWindow("ApplicationFrameWindow", "One Game Launcher (Pro)"))
    ...
    {
        Assert.Equal("OneGameLauncherPro", this.sut.Key);
    }

    [Fact]
    public void Description_IsCorrect()
    {
        Assert.Equal("One Game Launcher Pro", this.sut.Description);
    }
